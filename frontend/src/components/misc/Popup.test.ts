...
describe('Popup', () => {
	it('renders the content wrapper when open', async () => {
	...
	it('returns focus to the trigger before the content is removed when closing from inside', async () => {
		...
		let popupConnectedWhenFocusReturned: boolean | null = null
		trigger.addEventListener('focus', () => {
			popupConnectedWhenFocusReturned = popup.isConnected
		})
		...
		popupConnectedWhenFocusReturned = null
		await wrapper.setProps({open: false})

		expect(document.activeElement).toBe(trigger)
		// focus lands back on the trigger before the DOM patch unmounts the content
		expect(popupConnectedWhenFocusReturned).toBe(true)
