...
func countTasksInBucket(s *xorm.Session, a web.Auth, bucket *Bucket) (taskCount int64, err error) {
	...
	return countTasksInBucketView(s, a, bucket, view)
}

func countTasksInBucketView(s *xorm.Session, a web.Auth, bucket *Bucket, view *ProjectView) (taskCount int64, err error) {
...
func checkBucketLimit(s *xorm.Session, a web.Auth, t *Task, bucket *Bucket, view *ProjectView, pendingInBatch int64) (taskCount int64, err error) {
	taskCount, err = countTasksInBucketView(s, a, bucket, view)
	if err != nil {
		return 0, err
	}
